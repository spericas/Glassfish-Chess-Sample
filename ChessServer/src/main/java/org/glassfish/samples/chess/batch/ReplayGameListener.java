...
/**
 * ReplayGameListener class.
 *
 * @author Santiago.Pericas-Geertsen@oracle.com
 */
@Named("ReplayGameListener")
public class ReplayGameListener extends AbstractJobListener {
    ...
    public void afterJob() throws Exception {
        catalog.getLatch().countDown();
        if (logger.logInfo()) {
            logger.info("[ReplayGame] Job completed");
        }
    }
}
