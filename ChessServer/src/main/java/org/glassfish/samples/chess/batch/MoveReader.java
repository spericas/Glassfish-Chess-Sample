 ...
 */
@Named("MoveReader")
public class MoveReader extends AbstractItemReader {
    ...
    private Iterator<MoveEntity> iterator;
    ...
    public void open(Serializable e) throws Exception {
        ...
        GameEntity entity = gameCatalog.getGameEntity(gameId);
        iterator = entity.getMoveList().iterator();
    }
